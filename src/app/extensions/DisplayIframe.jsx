...
const Extension = ({ openIframe }) => {
  const handleClick = () => {
    openIframe({
      uri: "http://21708219.hs-sites.com/document-printer?required_id=21708219", // this is a relative link. Some links will be blocked since they don't allow iframing
      height: 1000,
      width: 1000,
    });
  };
